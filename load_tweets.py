...
# create/update the user
        if res.first() is None:
            ...
            VALUES (:id_users, :created_at, :id_urls, :friends_count, :listed_count, :favourites_count, :statuses_count, :protected, :verified, :screen_name, :name, :location, :description)
            ON CONFLICT DO NOTHING
            RETURNING id_users
                ''')
        else:
        ...
        sql=sqlalchemy.sql.text(f'''
         INSERT INTO tweets
            ...
            VALUES (:id_tweets, :id_users, :created_at, :in_reply_to_status_id, :in_reply_to_user_id, :retweet_count, :favorite_count, :quote_count, :source, :text, :country_code, :state_code, :lang, :place_name)
            ''')
        res = connection.execute(sql, {
            'id_tweets': tweet['id'],
            'id_users': tweet['user']['id'],
